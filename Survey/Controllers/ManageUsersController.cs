...
namespace Survey.Controllers
{
    public class ManageUsersController : Controller
    {
        ...
        [HttpPost]
        public ActionResult Create(ManageUsers manageUsers)
        {
            try
            {
                ...
                var Sql = "INSERT INTO [dbo].[Users] " +
                          "([RoleId],[UserName],[Password],[FirstName],[MiddleName],[LastName],[Email],[Phone]) " +
                          "VALUES " +
                          "(@RoleId,@UserName,@Password,@FirstName,@MiddleName,@LastName,@Email,@Phone)";
                ...
                cmd.Parameters.AddWithValue("@MiddleName", manageUsers.MiddleName);
        ...
        public ActionResult Edit(int id)
        {
            ...
            if (datatable.Rows.Count == 1)
            {
                ...
                manageUsers.MiddleName = datatable.Rows[0]["MiddleName"].ToString();
        ...
        [HttpPost]
        public ActionResult Edit(int id, ManageUsers manageUsers)
        {
            try
            {
